...
@Component
@Slf4j
public class SysAclLogger implements SysLogger {
    ...
    public SysOpLog buildOpLog(SysAudit sysAudit) {
        ...
        switch (sysAudit.getOperationType()) {
            case 1:
                sysOpLog.setInterfaceName(AuthConstant.aclAddMethodName);
                break;
            case 2:
                sysOpLog.setInterfaceName(AuthConstant.aclUpdateMethodName);
                break;
            case 3:
                sysOpLog.setInterfaceName(AuthConstant.aclDeleteMethodName);
                break;
            default:
                break;
        }
