...
@Slf4j
@Component
public class SysRoleLogger implements SysLogger {
    ...
    public SysOpLog getOpLog(SysAudit sysAudit) {
        ...
        switch (sysAudit.getOperationType()) {
            case 1:
                sysOpLog.setInterfaceName(AuthConstant.roleAddMethodName);
                break;
            case 2:
                sysOpLog.setInterfaceName(AuthConstant.roleUpdateMethodName);
                break;
            case 3:
                sysOpLog.setInterfaceName(AuthConstant.roleDeleteMethodName);
                break;
            default:
                break;
        }
